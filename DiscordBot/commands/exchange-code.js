...
module.exports = {
  commandInfo: {
    name: "exchange-code",
    description:
      "Generates an exchange code for login. (One time use and expires after 5 mins if unused).",
  },
  execute: async (interaction) => {
    ...
    let exchange_code = functions.MakeID().replace(/-/gi, "");
    ...
    let embed = new MessageEmbed()
      ...
      .setFields({ name: "Exchange Code", value: exchange_code })
      .setTimestamp();
